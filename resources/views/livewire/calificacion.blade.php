<div class="text-white">
    <h2 class="text-yellow">Check-In peso</h2>
                ...
                <div class="container-fluid mt-4 text-white">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <select id="cinta" name="cinta" wire:model="cinta" class="form-select mb-3" disabled>
                    ...
                    <div class="row mb-4 justify-content-space-between">
                        <!-- Peso -->
                        <div class="col-md-4">
                            <label for="peso" class="form-label">Introduce el peso</label>
                            <div class="input-group">
                                <input type="number" step="1" class="form-control custom-form-control"
                                    oninput="validarDosDecimales(this)" wire:model="peso">
                    ...
                    <div>
                        <h3 class="text-yellow">Categorías inscritas</h3>
                        <table class="table table-striped table-dark table-responsive">
                            ...
                            <tbody>
                                @forelse ($categoriasInscritas as $categoriaInscrita)
                                    <tr>
                                        <td>{{ $categoriaInscrita->categoria->nombre }}</td>
                                        <td>{{ $categoriaInscrita->categoria->division }}</td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="6">No hay categorías inscritas.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
                    ...
                    @forelse ($categoriasFiltradas as $item)
                        <table class="table table-dark mt-3">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <input type="checkbox" wire:model="selectedCategories" class="genero-radio3"
                                            value="{{ $item['id'] }}">
                                    </td>
                ...
                <div class="alert alert-info">
                    ...
                    <ul>
                        @foreach (session('selectedCategoriesInfo', collect()) as $categoria)
                            <li>{{ $categoria->nombre . ' ' . $categoria->division }} &nbsp;
...
<script>
    function validarDosDecimales(input) {
