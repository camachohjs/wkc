...
class TorneosMenu extends Component
{
    use WithPagination;
    public $torneoId;
    ...
    public function Registro($torneoId)
    {
        $this->torneoId = $torneoId;
        return redirect()->route('registro-alumno', ['torneo_id' => $torneoId]);
    }
    ...
    public function render()
    {
        ...
        return view('livewire.torneosmenu', [
            'torneos' => $torneos,
        ]);
    }
