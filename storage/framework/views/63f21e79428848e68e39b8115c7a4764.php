        ...
        <nav class="navbar navbar-expand-lg text-white">
            <div class="container-fluid text-center">
                <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                    <img src="<?php echo e(asset('Img/KARATE.png')); ?>" class="logo" alt="WKC - KARATE">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 align-items-center">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url('/atletas-grid')); ?>">Competidores</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('clasificaciones.index')); ?>">Ranking</a>
                        </li>
                    </ul>
                    <ul class="navbar-nav mx-auto align-item-center">
                        <?php if(auth()->guard()->check()): ?>
                            <li class="nav-item">
                                <a class="btn btn2" href="<?php echo e(url('/panel')); ?>">
                                    Dashboard
                                </a>
                            </li>
                        <?php else: ?>
                            <li>
                                <a class="btn btn2" href="<?php echo e(route('login')); ?>">
                                    Iniciar Sesión
                                </a>
                            </li>
                        <?php endif; ?>
            ...
            <div class="row gy-4 gy-lg-0 d-flex justify-content-center">
                ...
                <div class="col-8 col-sm-8 col-md-3">
                    <div class="widget">
                        ...
                        <ul class="list-unstyled">
                            <li class="mb-2">
                                <a href="<?php echo e(url('/eventos')); ?>" class="text-white footer">Eventos</a>
                            </li>
                            <li class="mb-2">
                                <a href="<?php echo e(url('/clasificaciones')); ?>" class="text-white footer">Ranking</a>
                            </li>
                            <li class="mb-2">
                                <a href="<?php echo e(url('/atletas-grid')); ?>" class="text-white footer">Competidores</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-8 col-sm-8 col-md-3">
                    <div class="widget">
                        ...
                        <ul class="list-unstyled">
                            <li class="mb-2">
                                <a href="<?php echo e(asset('Reglamento.pdf')); ?>" class="text-white footer"
                ...
                <div class="col-8 col-sm-8 col-md-3">
                    <div class="widget">
                        ...
                        <ul class="list-unstyled">
                            <li class="mb-2">
                                <a href="<?php echo e(url('/blog')); ?>" class="text-white footer">Blog</a>
                            </li>
                            <li class="mb-2">
                                <a href="<?php echo e(url('/register')); ?>" class="text-white footer">Registrate</a>
                            </li>
                            <li class="mb-2">
...
<?php /**PATH C:\laragon\www\wkc\resources\views/components/layouts/app.blade.php ENDPATH**/ ?>